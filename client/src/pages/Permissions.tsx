...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  'reports:sales_agencias': 'Reporte de Ventas Agencias',
  'inventory:read': 'Ver inventario y Mi Inventario',
  'inventory:sell': 'Punto de Venta y Venta General',
  'inventory:move': 'Movimientos, Asignaciones, Cargar inventario',
  'inventory:dashboard': 'Dashboard General y Resumen Ventas',
  'inventory:users': 'Crear y gestionar Usuarios de Inventario',
  'inventory:manage': 'Crear almacenes, inventario inicial (admin)',
  'loteria:dashboard': 'Dashboard Loteria (agencias)',
...
const PERMISSION_GROUPS: Record<string, string[]> = {
  ...
  'Reportes': ['reports:read', 'reports:export', 'reports:sales', 'reports:sales_agencias'],
  'Inventario General': ['inventory:read', 'inventory:sell', 'inventory:move', 'inventory:dashboard', 'inventory:users', 'inventory:manage'],
  'Loteria': ['loteria:dashboard'],
