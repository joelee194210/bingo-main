...
import {
  ...
  BarChart3, PieChart as PieChartIcon, Loader2, Warehouse,
} from 'lucide-react';
...
export default function DashboardGeneral() {
  ...
  const { data: dashData, isLoading } = useQuery({
    ...
    queryFn: () => getDashboardGeneral(eventId!),
    enabled: !!eventId,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Dashboard General</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Estadisticas de ventas por todos los almacenes
          </p>
        </div>
        <Select
      ...
      {isLoading ? (
        ...
        <>
          ...
          {/* Charts Row 1: Ventas por día + Pie */}
                ...
                {ventasDiaData.length > 0 ? (
                  <ResponsiveContainer width="100%" height={280}>
                    <AreaChart data={ventasDiaData}>
                      <defs>
                        <linearGradient id="colorVentasGeneral" x1="0" y1="0" x2="0" y2="1">
          ...
          {/* Charts Row 2: Almacenes bar chart + Ranking */}
          ...
          {dashboard.almacenes.filter(a => a.total_cartones > 0).length === 0 && (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-1">Sin almacenes con inventario</h3>
                <p className="text-sm text-muted-foreground">
                  Asigna cartones a almacenes para ver las estadisticas aqui.
                </p>
              </CardContent>
            </Card>
          )}
