...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
  ...
  <p>Tu compra ha sido confirmada exitosamente. Ya eres parte del <strong style="color:#dc2626;">Mega Bingo TV Mundial</strong>. Tus cartones están listos para descargar.</p>
  ...
  <p style="color: #94a3b8; font-size: 11px; margin-top: 30px; text-align: center;">
    Mega Bingo TV Mundial &copy; ${new Date().getFullYear()}
  </p>
</body>
</html>`;
